...
//		return args -> {
//
//			User user1 = new User("admin", pwEncoder.encode("admin"), "martijn.reede@gmail.com", "Martijn", "Reede", "Huizumerlaan 158", "06-11433823", "Amsterdam");
//			user1.setRole("ROLE_ADMIN");
//
//			User user2 = new User("moderator", pwEncoder.encode("moderator"), "cyrille.jones@gamail.com", "Cyrille", "Jones", "Hugo de Grootstraat 174", "06-87054875", "Sliedrecht");
//			user2.setRole("ROLE_MODERATOR");
//
//			User user3 = new User("user", pwEncoder.encode("user"), "kevin.leijnse@gmail.com", "Kevin", "Leijnse", "Leidijk 97", "06-18756892", "Groningen");
